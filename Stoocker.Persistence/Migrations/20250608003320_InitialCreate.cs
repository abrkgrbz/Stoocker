        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowMultiWarehouse = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    PrimaryColor = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: true, defaultValue: "#3498db"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Color = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: true, defaultValue: "#3498db"),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendEmailInvoice = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsSystemUnit = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinSalePrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ...
                    TaxRate = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 18.00m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StorageCapacity = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    MaxProductCount = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_TenantId_EntityName_Action",
                table: "AuditLogs",
                columns: new[] { "TenantId", "EntityName", "Action" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_CurrentStock",
                table: "ProductStocks",
                column: "CurrentStock");

            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_LastMovementDate",
                table: "ProductStocks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseInvoiceDetails_InvoiceId_LineNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoiceDetails_InvoiceId_LineNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoices_TenantId_InvoiceDate",
                table: "SalesInvoices",
                columns: new[] { "TenantId", "InvoiceDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_TenantId_ProductId_MovementDate",
                table: "StockMovements",
